...
app.get('/', function (req, res) {
  ...
  res.render('practice27', { title: '폼 전송을 배워보자', desc: '여기는 설명' }); // views/index.ejs 파일을 찾아서 클라이언트에게 "응답"
});
...
app.get('/result26', function(req,res){ 
  console.log(req.query);
  res.render('practice26_result',{title:'실습26 폼 전송 완료!', 
  userInfo:req.query})
})

app.post('/result27',function(req,res){
  console.log(req.body);
  res.render('practice27_result', {title:'실습27 폼 전송 완료',
  userInfo: req.body})
